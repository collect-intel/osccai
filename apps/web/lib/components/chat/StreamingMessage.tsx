    ...
    <div className={`min-h-[1.5em] ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h2: ({ children }) => <h2 className="text-xl font-bold mb-3 mt-5 first:mt-0 text-white">{children}</h2>,
          h3: ({ children }) => <h3 className="text-lg font-bold mb-2 mt-4 first:mt-0 text-white">{children}</h3>,
          blockquote: ({ children }) => (
