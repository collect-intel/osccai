...
async function testPostRequest() {
  try {
    const consensusServiceUrl = process.env.CONSENSUS_SERVICE_URL || 'http://localhost:6000';
    const pollId = 'cm7yf3he90000h4yzb5oyurgi'; // Use the same poll ID as in your test
    
    console.log(`Testing POST request to consensus service at: ${consensusServiceUrl}`);
