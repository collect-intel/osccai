...
`,
            ...
            hints: {
              refined_constitution:
                "Refined constitution in markdown format with headings and bullet points. E.g. \n# Constitution on ____\n## Preamble\n...Etc.",
              constitution_metrics: {
                metric: [
                  "A singular metric an AI can measure itself according to.",
                ],
              },
              reflection:
                "An initial reflection of what you think the constitution should contain, based on the initial user-provided constitution.",
            },
          }),
        ];
      }, clientProvider);
      ...
      <div className="max-w-[1600px] mx-auto bg-white/50 rounded-2xl shadow-sm overflow-hidden">
        ...
        <header className="px-4 pt-4 lg:px-8 lg:pt-6">
          <h1 className="text-xl lg:text-2xl font-bold text-gray-800">
            Experiment with your own AI Constitution
          </h1>
          ...
          >
            ...
            >
              <ConstitutionalAIChat
                ...
                customStyles={{
                  userMessage:
                    "bg-gray-50/50 rounded-lg p-4 mb-4 shadow-[0_1px_3px_rgba(0,0,0,0.05)]",
                  aiMessage:
                    "bg-teal/95 rounded-lg p-4 mb-4 shadow-[0_1px_3px_rgba(0,0,0,0.05)] text-white",
