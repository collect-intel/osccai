...
import pandas as pd
from kneed import KneeLocator  # Added import
...
def perform_clustering(imputed_vote_matrix):
    ...
    # log the imputed vote matrix in a format that is easy to read all the values in the rows and columns, without column or row labels
