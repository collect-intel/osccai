  ...
  return (
    <div className="max-w-2xl mx-auto px-4">
      ...
      <form action={handleSubmit} className="space-y-6">
        ...
        <div>
          <label htmlFor="initialIdea" className="block text-sm font-medium text-gray-700">Describe your community model and its purpose</label>
          <textarea
            name="initialIdea"
            id="initialIdea"
            rows={4}
        ...
        <button type="submit" className="w-full bg-teal text-white font-medium py-2 px-4 rounded hover:bg-teal-dark transition-colors">
          Create Model
        </button>
      </form>
    </div>
