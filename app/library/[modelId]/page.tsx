...
export default async function PublicCommunityModelPage({ params }: { params: { modelId: string } }) {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-8">
        ...
        {communityModel.activeConstitution ? (
          <ChatInterface constitutionId={communityModel.activeConstitution.uid} />
        ) : (
          <p className="text-gray-600">This community model doesn't have an active constitution yet.</p>
        )}
      </div>
    </div>
  );
