...
const AIResponseModal: React.FC<AIResponseModalProps> = ({ isOpen, onClose, message }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div ref={modalRef} className="bg-white rounded-lg p-6 max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        {message.draft_response && (
          <div className="mb-4">
            ...
            <ReactMarkdown className="bg-gray-100 p-2 rounded">{message.draft_response}</ReactMarkdown>
          </div>
        )}
        ...
        {message.response_metrics && (
          <div className="mb-4">
            ...
            <ReactMarkdown className="bg-gray-100 p-2 rounded">{message.response_metrics}</ReactMarkdown>
          </div>
        )}
        ...
        {message.improvement_strategy && (
          <div className="mb-4">
            ...
            <ReactMarkdown className="bg-gray-100 p-2 rounded">{message.improvement_strategy}</ReactMarkdown>
          </div>
        )}
