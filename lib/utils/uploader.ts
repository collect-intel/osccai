...
export async function upload(file: UploadFile, fileUse: keyof typeof FILE_USES, oldFileUrl?: string) {
...
export async function deleteFile(fileUse: keyof typeof FILE_USES, fileUrl: string) {
