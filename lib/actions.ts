...
import type { Poll, VoteValue as VoteValueType, Statement } from "@prisma/client";
...
import { generateStatementsFromIdea, generateSimpleConstitution } from './aiActions';
          ...
          statements: {
            include: {
              votes: {
                where: {
                  createdAt: {
                    gt: (await prisma.constitution.findFirst({
